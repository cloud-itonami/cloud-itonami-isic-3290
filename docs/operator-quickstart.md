# Operator Quickstart — Other manufacturing n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 3290** (`cloud-itonami-isic-3290`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3290.git
cd cloud-itonami-isic-3290
```
...
- Blueprint governor key: `writing-instrument-plant-operations-governor`
- Likely source path: `penmfg.governor.cljc`
